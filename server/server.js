...
const interestsFolderEquipments = require("./routes/interestFolderEquipments");
const interestNotification = require("./routes/interestNotification");
const preferredStoresInterests = require("./routes/preferredStoresInterests");
const model = require("./routes/model");
const organizer = require("./routes/organizer");
const part = require("./routes/part");
const repair = require("./routes/repair");
const repairParts = require("./routes/repairParts");
...
app.use("/api/preferredStoresInterests", preferredStoresInterests);
app.use("/api/interestsFolderEquipments", interestsFolderEquipments);
app.use("/api/interestNotification", interestNotification);
app.use("/api/model", model);
app.use("/api/organizer", organizer);
app.use("/api/part", part);
app.use("/api/repair", repair);
app.use("/api/repairParts", repairParts);
