...
router.get("/", async (req, res) => {
  try {
    ...
    const { name, clientNIC, page=1, pageSize=10, orderBy = "createdAt", orderDirection = "DESC" } = req.query;
    ...
    const clientCondition = clientNIC ? { nic: clientNIC } : {}; // busca o clientes cujo NIC corresponde ao fornecido 
