...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      "Brands",
      [
        { name: "Apple", isActive: "1", createdAt: new Date(), updatedAt: new Date(),},
        { name: "Samsung", isActive: "1", createdAt: new Date(), updatedAt: new Date(), },
        { name: "Sony", isActive: "1", createdAt: new Date(), updatedAt: new Date(), },
        { name: "Dell", isActive: "1", createdAt: new Date(), updatedAt: new Date(), },
        { name: "HP", isActive: "1", createdAt: new Date(),updatedAt: new Date(),},
        ...
        { name: "JBL", isActive: "1",createdAt: new Date(),updatedAt: new Date(),},
      ],
      {}
    );
  },
