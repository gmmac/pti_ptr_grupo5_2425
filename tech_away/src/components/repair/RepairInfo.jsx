			...
			<Modal.Body className="p-4">
				{repair ? (
					<Row>
						...
						<Col md={5}>
							<Card className="mb-3 shadow-sm">
								<Card.Body>
									<p className="fw-bold">
										<FileText /> Nº Repair:{" "}
										<span className="fw-normal text-primary">#{repair.id}</span>
									</p>
									<p className="fw-bold">
										<Calendar /> Created At:{" "}
									...
									<p className="fw-bold">
										<Calendar /> Estimated Delivery:{" "}
										<span className="fw-normal">
											{new Date(
												repair.estimatedDeliverDate
											).toLocaleDateString()}
										</span>
									</p>
									<p className="fw-bold">
										<FileText /> Description:{" "}
										<span className="fw-normal">{repair.description}</span>
									</p>
									<p className="fw-bold">
										<Wallet /> Budget:{" "}
										<span className="fw-normal">{repair.budget}€</span>
									</p>
									<p className="fw-bold">
										<People /> Employee:{" "}
										<span className="fw-normal">
											{repair.Employee
												? `${repair.Employee.firstName} ${repair.Employee.lastName}`
									...
									<p className="fw-bold">
										<Shop /> Store:{" "}
										<span className="fw-normal">
											{repair.Employee && repair.Employee.Store
												? repair.Employee.Store.name
												: "No Store Assigned"}
										</span>
									</p>
									<p className="fw-bold">
										...
										<span
											className={`badge ${
												repair.RepairStatus?.state === "Completed"
													? "bg-success"
													: "bg-primary"
											} ms-2`}
										>
						...
						>
							<div
								style={{ borderLeft: "2px solid #ccc", height: "100%" }}
							></div>
						</Col>
									...
									<div className="overflow-auto" style={{ maxHeight: "300px" }}>
										{repairStatusLogs.length > 0 ? (
											...
											<p className="text-muted">
												No status history available. Please contact the store.
											</p>
										)}
									</div>
								</Card.Body>
