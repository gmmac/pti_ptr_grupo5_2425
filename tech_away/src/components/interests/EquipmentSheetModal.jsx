			...
			try {
				...
				for (const field of fields) {
					try {
						...
						console.warn(`Erro ao pesquisar por ${field}:`, err.message);
					}
				}

				// Se nenhuma pesquisa devolveu resultados
				clearTable();
				setColumns([]); // opcional: esconder tudo se não houver resultados
			} catch (err) {
				console.error("Erro geral na pesquisa:", err);
				clearTable();
				setColumns([]); // opcional: esconder tudo em erro
			}
		};
